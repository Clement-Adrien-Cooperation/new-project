...
export const AccountPageMetadata: FC = () => {
  const { translate } = useI18n()

  const appName = translate('appName')

  const accountPageMetadata: Metadata = {
    ...DEFAULT_METADATA,
    ...
    title: mergeTitle(translate('pages.auth.account.metadata.title'), appName),
    url: mergeUrl(ROUTES.login)
  }

  return <PageMetadata {...accountPageMetadata} />
}
